...
describe('üyelik durumu türetimi', () => {
  it('ÜRETİMDEKİ HÂL: ücretlendirme ertelendi (19.09.2026), hiçbir uyarı yok', () => {
    /* Ürün sahibi kararı: kullanıcı kitlesi oluşmadan ve App Store IAP
       kararı verilmeden fiyat/deneme gösterilmez. Açık hâlin davranışı
       aşağıdaki parametreli senaryolarda korunuyor. */
