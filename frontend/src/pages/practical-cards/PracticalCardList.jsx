  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Pratik Kartlar</h1>
        <Link to="/app/practical-cards/saved" className="text-primary-600 hover:text-primary-800 font-medium">
          Kaydedilen Kartlarım
        </Link>
      </div>

      <p className="text-gray-600 mb-8">İşletmeniz için kritik karar noktalarında kullanabileceğiniz, eyleme dönük pratik formüller ve kontrol listeleri.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map(card => (
            <Link 
              ...
              className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-200 overflow-hidden flex flex-col h-full"
            >
